...
//https://stackoverflow.com/questions/54699670/unity-width-and-height-of-the-gameobject
...
public class BigMaskMove : MonoBehaviour
{
    public float speed = .05f;

    public bool bigMaskAligned = false;
    ...
    void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        if (collision.CompareTag("bigTrigger"))
        {
            bigMaskAligned = true;
        }
    }
